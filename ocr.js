...
async function leerTexto() {
    try {
        console.log("Enviando imagen en Azure...")
        ...
        while (true) {
            ...
            // Esperamos un segundo para volver a intentarlo
            await new Promise(resolve => setTimeout(resolve, 1000))
        }

        // PARTE 3 - Extraer y mostrar texto detectado
        console.log("Texto detectado")

        // Como el resultado se encuentra dentro de una matriz [[]]
        // Necesitamos recorrer la estructura con 2 ciclos
